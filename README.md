...
[![Top Langs](https://itsmateo20-profile-stats.vercel.app/api/top-langs/?username=itsmateo20&exclude_repo=itsmateo20&langs_count=20&layout=compact&theme=github_dark_dimmed&card_width=467px)](https://github.com/itsmateo20)
[![Stats](https://itsmateo20-profile-stats.vercel.app/api?username=itsmateo20&show_icons=true&theme=github_dark_dimmed&line_height=20&custom_title=itsmateo20%20Github%20Stats)](https://github.com/itsmateo20)
...
- **Web Cloud Storage:** My web cloud storage system made from scratch used for accessing files from a drive through the web, which took about 3 weeks to create, and it's fully functional and [open-source](https://github.com/itsmateo20/Cloud). [preview website](https://itsmateo20.github.io/Cloud)  
  The project is being **AI-assisted using GitHub Copilot and selected AI agents** during development.
  ...
  [![Readme Card](https://itsmateo20-profile-stats.vercel.app/api/pin/?username=itsmateo20&repo=Cloud&theme=github_dark_dimmed&show_owner=true&show_icons=true&card_width=600px)](https://github.com/itsmateo20/Cloud)

- **Facebook Messenger Data Analysis:** A completed project that provides insightful information based on your data downloaded from Facebook Messenger. It includes details such as the number of words sent and call duration.  
  This project was **fully generated by AI with 0 lines of code written by me manually**.  
  [Github Repository](https://github.com/itsmateo20/Facebook-Messenger-Data-Analysis) | [Preview Website](https://itsmateo20.github.io/Facebook-Messenger-Data-Analysis)
  ...
  [![Readme Card](https://itsmateo20-profile-stats.vercel.app/api/pin/?username=itsmateo20&repo=Facebook-Messenger-Data-Analysis&theme=github_dark_dimmed&show_owner=true&show_icons=true&card_width=600px)](https://github.com/itsmateo20/Facebook-Messenger-Data-Analysis)

- **CpuTempPlugin:** A lightweight Minecraft server plugin and PlaceholderAPI (PAPI) expansion that reads and displays the host server's CPU temperature.                                                               
  This project was **fully generated by AI with 0 lines of code written by me manually**.  
  [Github Repository](https://github.com/itsmateo20/CpuTempPlugin)

  [![Last commit](https://img.shields.io/github/last-commit/itsmateo20/CpuTempPlugin?style=flat-square&labelColor=gray&color=blue)](https://github.com/itsmateo20/CpuTempPlugin/commit/main) [![Release](https://img.shields.io/github/v/release/itsmateo20/CpuTempPlugin?include_prereleases&sort=date&display_name=tag&style=flat-square&labelColor=gray&color=blue)](https://github.com/itsmateo20/CpuTempPlugin/releases/latest)

  [![Readme Card](https://itsmateo20-profile-stats.vercel.app/api/pin/?username=itsmateo20&repo=CpuTempPlugin&theme=github_dark_dimmed&show_owner=true&show_icons=true&card_width=600px)](https://github.com/itsmateo20/CpuTempPlugin)
...
- <details>
  <summary><b>Genius Lyrics:</b> Check out my added lyrics on <a href="https://genius.com/itsmateo20"> Genius</a>. I add lyrics to songs I listen to but aren't on Genius in my free time.</summary>

  - **Plany - NLT (NICOTINE LOVER TEAM) ft. sonia** | [Lyrics](https://genius.com/Nicotine-lover-team-plany-lyrics) 
  - **Hałas - KeliQ** | [Lyrics](https://genius.com/Keliq-haas-lyrics)
  - **Meow - $even** | [Lyrics](https://genius.com/Even-pol-meow-lyrics)
    
  </details>

- <details>
  <summary><b>Discontinued projects</b></summary>

  - **Draid Bot (DISCONTINUED):** My Discord Bot, <a href="https://draid.vercel.app/goodbye">Draid</a>, served over 40 servers from 2021 to 2023 and has now been retired. It was **hand-coded entirely with help from Stack Overflow**, and it represents my **first real large-scale project that taught me how to code**.

    [![Readme Card](https://itsmateo20-profile-stats.vercel.app/api/pin/?username=itsmateo20&repo=DraidB&theme=github_dark_dimmed&show_owner=true&show_icons=true)](https://github.com/itsmateo20/DraidB)

  - **Draid Website:** Dashboard website for the Draid Bot, also **fully hand-coded with Stack Overflow assistance**, built during the same early learning phase and closely tied to the bot.

    [![Readme Card](https://itsmateo20-profile-stats.vercel.app/api/pin/?username=itsmateo20&repo=DraidW&theme=github_dark_dimmed&show_owner=true&show_icons=true&card_width=500px)](https://github.com/itsmateo20/DraidW)

  - **Librusio (DISCONTINUED):** An unofficial Android application that allows students using the Librus Synergia system to view their grades, calendar, and messages in real time for free, unlike the official app, which requires a paid subscription to access real-time data and certain features.
...
_"**Zauważ mnie**, a zobaczysz, co straciłaś. 💔"_<br>
~ _**Mateusz Starkiewicz (itsmateo20)**_
...
- And much more social media platforms using the username "itsmateo20", "xCzepek" or "matixo".
